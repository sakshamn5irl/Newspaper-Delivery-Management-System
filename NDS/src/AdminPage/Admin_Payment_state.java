...
public class Admin_Payment_state extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_Payment_state frame = new Admin_Payment_state();
	 ...
	 * @throws SQLException 
	 */
	public Admin_Payment_state() throws SQLException {
