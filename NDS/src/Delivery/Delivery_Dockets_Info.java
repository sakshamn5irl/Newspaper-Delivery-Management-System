...
public class Delivery_Dockets_Info extends JPanel {
	static int cust_id = 1;
	static String[] type = {"Hello","World"};
	
	public Delivery_Dockets_Info() throws SQLException {
        initializeUI();    
    }
    ...
    public static void showFrame() throws SQLException {
        JPanel panel = new Delivery_Dockets_Info();
   ...
   /* public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
					Delivery_Dockets_Info.showFrame();
