...
/*	public void testRegister_user() {
	 ...
	 * Expected Output: The function should return number of delivery areas present in the database.
	 ...
	 * Expected Output: The function should return number of values in stocks
	...
	{
		DefaultTableModel model = ConnectDB.getDefaulterInfor();
		int num = model.getColumnCount();
		assertEquals(6, num);
	}
	...
	{
		int num = ConnectDB.updatePaymentStatus(1, 1);
		assertEquals(1, num);
	}
	...
	/***
	 * Test No.28
	 * Objective: To test the getUnassignedIds() Method
	 * Inputs: getUnassignedIds runs Select Query
	 * Expected Output: The function should return 1 if successful
	 
	 ***/
	@Test
	public void testgetUnassignedIds() throws SQLException
	{
		int[] arr = ConnectDB.getUnassignedAgentIds();
		assertEquals(15, arr.length);
	}
	
	/***
	 * Test No.29
	 * Objective: To test the getAreaIds() Method
	 * Inputs: getAreaIds runs Select Query
	 * Expected Output: The function should return 1 if successful
	 
	 ***/
	@Test
	public void testgetAreaIds() throws SQLException
	{
		int[] arr = ConnectDB.getAreaIds();		
		assertEquals(15, arr.length);
	}
	/***
	 * Test No.30
	 * Objective: To test the getAssignedAreaIds() Method
	 * Inputs: getAssignedAreaIds runs Select Query
	 * Expected Output: The function should return 1 if successful
	 
	 ***/
	@Test
	public void testgetAssignedAreaIds() throws SQLException
	{
		int[] arr = ConnectDB.getAssignedAreaIds();
		assertEquals(15, arr.length);
	}
